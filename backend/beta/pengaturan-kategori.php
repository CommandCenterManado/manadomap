...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dist/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css"/>
	<!-- Sweet Allert -->
	...
	<div id="myModal" class="modal fade" role="dialog">
		...
		<form>
			...
			<div class="modal-body">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox"/> Centang bila kategori dapat di estimasi.
					</label>
				</div>
				<!-- Example 3 -->
...
<script type="text/javascript" src="dist/bootstrap-iconpicker/js/iconset/iconset-fontawesome-4.3.0.min.js"></script>
<!-- Bootstrap-Iconpicker -->
<script type="text/javascript" src="dist/bootstrap-iconpicker/js/bootstrap-iconpicker.min.js"></script>
<!-- Sweet Allert -->
