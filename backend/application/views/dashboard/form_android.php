            ...
            <?php foreach($laporan as $l): ?>
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="opts">
                            <a data-l='<?php echo htmlspecialchars(json_encode($l),ENT_QUOTES,"UTF-8"); ?>' href="javascript:void(0);" class="btn green approve"><i class="fa fa-arrow-circle-o-right fa-lg"></i>&nbsp;Setuju</a><a href="#" class="btn red"><i class="fa fa-trash fa-lg"></i>&nbsp;Hapus</a>
                        </div>
                    </div>
                </div>
            <?php endforeach;?>
